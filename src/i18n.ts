...
export const I18N: Record<Lang, I18nDict> = {
  it: {
    ...
    difficulty: 'Difficoltà bot', opponentsHint: 'Premi Ricomincia per applicare i cambiamenti.', playerNameLabel: 'Il tuo nome', playerNamePlaceholder: 'Giocatore 1',
  ...
  en: {
    ...
    difficulty: 'Bot difficulty', opponentsHint: 'Press Restart to apply your changes.', playerNameLabel: 'Your name', playerNamePlaceholder: 'Player 1',
  ...
  fr: {
    ...
    difficulty: 'Difficulté bot', opponentsHint: 'Appuie sur Recommencer pour appliquer.', playerNameLabel: 'Ton nom', playerNamePlaceholder: 'Joueur 1',
